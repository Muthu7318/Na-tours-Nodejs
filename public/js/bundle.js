...
if (formElement) {
  formElement.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value; // let myForm = document.getElementById('form');
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password, formData) {
    var res;
